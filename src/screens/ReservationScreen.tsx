    ...
    return (
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            ...
            <View style={styles.section}>
                ...
                <TouchableOpacity style={styles.hostButton2} onPress={() => setShowDateDebutPicker(true)}>
                ...
                <TouchableOpacity style={styles.hostButton2} onPress={() => setShowDateFinPicker(true)}>
